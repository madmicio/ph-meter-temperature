...
class PhMeterCard extends LitElement {
  ...
  <text id="_1" data-name="1" class="cls-1" x="351.5" y="333"><tspan x="351.5">${stateObj.state != "unavailable" ? temp_split_int : ' '}</tspan></text>
  <text id="_.23" data-name=".23" class="cls-2" x="388.5" y="333">.${stateObj.state != "unavailable" ? temp_split_dec : ' '}</text>
  ...
  .ph-cursor-space,.item-c-1,.item-temp {
      grid-column: 1/15;
      background-color: transparent
  }
