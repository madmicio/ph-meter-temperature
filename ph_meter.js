...
class PhMeterCard extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      <div class="grid-container_2">
          ...
          <div style="grid-column: 1 / 2;" class="grid-item_2 ">COLD</div>
          <div style="grid-column: 2 / 3; border-top: 1px solid var(--primary-text-color); margin-top: 10px" class="grid-item_2 "></div>
          <div style="grid-column: 3 / 4;" class="grid-item_2 ">TEMPERATURE</div>
          <div style="grid-column: 4 / 5; border-top: 1px solid var(--primary-text-color); margin-top: 10px" class="grid-item_2 "></div>
          <div style="grid-column: 5 / 6;" class="grid-item_2" ">HOT</div>

      <ul class="temp-box-gradient" style="background: linear-gradient(90deg, rgba(0,9,255,1) 0%, rgba(4,219,190,1) ${temp_min_range_percent}%, rgba(7,224,147,1) ${temp_min_range_percent_max}%, rgba(11,230,91,1) ${temp_max_range_percent}%, rgba(255,179,0,1) ${temp_max_range_percent_max}%, rgba(255,3,3,1) 100%);">
  ...
  <image id="h" width="379" height="467" xlink:href="data:img/png;base64,"/>
    ...
    <div class="grid-container">
          ...
          <div class="item-a" style="width: ${(stateObj.state * 6.66) - 2}%;">|</div>
          <div class="item-b"></div>
        </div>
    <div class="grid-container_3">
      
          <div style="grid-column: 1 / 2;" class="grid-item_2 ">ACIDIC</div>
          <div style="grid-column: 2 / 3; border-top: 1px solid var(--primary-text-color); margin-top: 10px" class="grid-item_2 "></div>
          <div style="grid-column: 3 / 4;" class="grid-item_2 ">NEUTRAL</div>
          <div style="grid-column: 4 / 5; border-top: 1px solid var(--primary-text-color); margin-top: 10px" class="grid-item_2 "></div>
          <div style="grid-column: 5 / 6;" class="grid-item_2" ">ALKALINE</div>
        </div>
  ...
  .item-b {
    ...
    background-color: transparent;
    border-radius: 5px;
    box-shadow: 5px 5px 7px inset rgba(0,0,0,0.5), -5px -5px 7px inset  rgba(0,0,0,0.5);
  }
  .item-c-1 {
    grid-column: 1 / 15;
    grid-row: 2 / 3;
  ...
  .temp-vale-box {
    ...
    box-shadow: -1px 2px 4px rgba(0,0,0,0.5), 1px 1px 3px rgba(0,0,0,0.5), -1px 2px 4px inset rgba(0,0,0,0.5), 1px 1px 3px inset rgba(0,0,0,0.5);
    text-shadow: -1px 2px 4px rgba(0,0,0,0.5),
                  1px 1px 3px rgba(0,0,0,0.5);
  }
  ...
  .logo {
    ...
    grid-template-rows: 47% 22% 15% 16%;
